...
```{r}
job_postings_df <- read_csv("/Users/aaliyahmjh/Downloads/job_postings.csv", show_col_types = FALSE)
job_skills_df <- read_csv("/Users/aaliyahmjh/Downloads/job_skills.csv", show_col_types = FALSE)
```
